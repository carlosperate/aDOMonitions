...
Post-process static HTML to convert blockquote and fenced markers into styled
admonition callout boxes. Zero dependencies, works with any static site
generator.

## What is this?

aDOMonitions scans the DOM for Admonition markers in HTML generated by a
static site generator without built-in admonition support.

It can look for either GitHub-style or Docusaurus-style markers.
